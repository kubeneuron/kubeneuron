...
var validTransitions = map[types.IncidentState][]types.IncidentState{
	...
	types.StateEvaluating:       {types.StateExecuting, types.StateAwaitingApproval, types.StateObserving, types.StateNeedsHuman, types.StateResolved},
